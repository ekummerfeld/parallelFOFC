 ...
 *
 * This version parallelizes the findPuretriples step
 *
 * @author Joseph Ramsey
 * @author Erich Kummerfeld
 */
public class ParallelFOFC {
    ...
    public ParallelFOFC(ICovarianceMatrix cov, TestType testType, Algorithm algorithm, double alpha) {
    ...
    public ParallelFOFC(DataSet dataSet, TestType testType, Algorithm algorithm, double alpha) {
        if (testType == null) throw new NullPointerException("Null test type.");
