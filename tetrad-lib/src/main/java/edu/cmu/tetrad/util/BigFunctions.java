...
public final class BigFunctions
{
    ...
    //added by Erich Kummerfeld for convenience. code grabbed from stackoverflow post
    public static BigDecimal pow(BigDecimal x, BigDecimal y, int scale){
        return exp(ln(x,scale).multiply(y),scale);
    }
}